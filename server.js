...
app.post("/", ({body: {username, alcohol, soft, comment, orderId, quantity}}, response) => {
    const html =
        ...
        + '<h2 style="text-align: center; font-size: small">' + quantity + ' ' + (alcohol ? alcohol + ' 🥃 ' : '' ) + (soft ? (alcohol ? ' + ' : '') + soft + ' 🥤 ' : '' ) + '</h2>'
